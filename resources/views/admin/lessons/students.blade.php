                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <!-- form start -->
                                        <form  method="POST" action="{{route('studentLessons.store')}}"  enctype="multipart/form-data">
                                            @csrf
                                            <div class="card-body">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer justify-content-between">
                                                ...
                                                <form action="{{route('studentLessons.destroy',$lesson->id)}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                ...
                                <div class="modal fade" id="modal-edit{{$lesson->id}}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- form start -->
                                                <form  method="POST" action="{{route('studentLessons.update',$lesson->id)}}"  enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PATCH')
